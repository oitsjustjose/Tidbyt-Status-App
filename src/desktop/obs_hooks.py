...
def on_event(event):
    ...
    backend_uri = getenv("TIDBYT_SERVER_URI", "http://172.16.1.3:8624")
    ...
    elif event == obspython.OBS_FRONTEND_EVENT_RECORDING_STOPPED or event == obspython.OBS_FRONTEND_EVENT_STREAMING_STOPPED:
